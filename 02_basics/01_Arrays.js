...
// myArr.push(6) // we have to pass argument in this and it will add the element in the array & also it will change the original array
...
console.log("A ", myArr);
const myn2 = myArr.splice(1, 3) // it will include elements which has indexing from 1 to 3 but it also manipulate the original array
console.log(myn2);
console.log("C ", myArr);

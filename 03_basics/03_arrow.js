const user = {  // this entire object is our current context
    ...
    welcomeMessage: function() {
        ...
        // console.log(this); // it will display everything which is there in this object
    }
}
...
// console.log(this);  // this will return an empty object as there is nothing in global
...
/*
whenever we use curly brackets we have to use 'return' keyword & whenever we use paranthesisat that time we don't write 'return' keyword & it is used for for a function which as onlysingle line in it
*/ 
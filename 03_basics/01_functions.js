...
// handleObject(user) // in this we are 1st creating an object & then using it to execute this we need to add the object name as argument then only it will work 
